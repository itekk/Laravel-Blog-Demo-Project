      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item">
              <a class="nav-link {{ request()->is('blogger/dashboard') ? 'active' : '' }}" aria-current="page" href="{{ route('blogger-dashboard') }}">Dashboard</a>
            </li>
            <li class="nav-item">
              <a class="nav-link {{ request()->is('blogger/blog-list') ? 'active' : '' }}" href="{{ route('blogger-list') }}">Blog</a>
            </li>
          </ul>
