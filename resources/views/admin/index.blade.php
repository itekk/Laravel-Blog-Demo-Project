...
@section('content')
  <div class="custom-container">
    ...
    <table class="table table-striped table-bordered table-hover table-responsive mb-5">
    ...
    <h5 class="text-center mb-3">Users/Blogs Overview</h5>
    <div class="row col-12 text-center">
      <div class="col-3">
        <a href="{{ route('admin-blogs') }}" class="text-decoration-none">
          <div class="card bg-info text-white">
            <div class="card-body">
              <h5 class="card-title mb-3">Total number of blogs</h5>
              <h3 class="card-text">
                {{ $totalBlogs }}
              </h3>
            </div>
      ...
      <div class="col-3">
        <a href="{{ route('admin-users') }}?type=blogger" class="text-decoration-none">
          <div class="card bg-success text-white">
            <div class="card-body">
              <h5 class="card-title mb-3">Total number of bloggers</h5>
              <h3 class="card-text">
                {{ $totalBlogger }}
              </h3>
            </div>
      ...
      <div class="col-3">
        <a href="{{ route('admin-users') }}?type=supervisor" class="text-decoration-none">
          <div class="card bg-primary text-white">
            <div class="card-body">
              <h5 class="card-title mb-3">Total number of supervisors</h5>
              <h3 class="card-text">
                {{ $totalSupervisor }}
              </h3>
            </div>
      ...
      <div class="col-3">
        <a href="{{ route('admin-users') }}?type=admin" class="text-decoration-none">
          <div class="card bg-secondary text-white">
            <div class="card-body">
              <h5 class="card-title mb-3">Total number of admin</h5>
              <h3 class="card-text">
                {{ $totalAdmin }}
              </h3>
            </div>
