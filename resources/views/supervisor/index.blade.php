...
@section('content')
  <div class="custom-container">
    ...
    <h5 class="text-center mb-3">Assigned Blogers/Blogs Overview</h5>
    <div class="row col-12 text-center d-flex justify-content-center">
      <div class="col-3">
        <a href="{{ route('supervisor-user-list') }}" class="text-decoration-none">
      ...
      <div class="col-3">
        <a href="{{ route('supervisor-blog-list') }}" class="text-decoration-none">
